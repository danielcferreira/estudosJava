...
public class TesteSubustituicaoAluno929 {
...
//		   aluno1.setDataMatricula("23/6/2000");
		...
		for (int pos = 0; pos<alunos.size();pos++) {
			...
			if(aluno.getNome().equalsIgnoreCase("daniel")){
				...
				troca.setNome("Aluno foi trocado");
				//trocando diciplina
				Diciplina diciplina = new Diciplina();
				diciplina.setDisciplina("mat");
				diciplina.setNota(9);
				
				troca.getDiciplinas().add(diciplina);
				
				//troca na lista do vetor
